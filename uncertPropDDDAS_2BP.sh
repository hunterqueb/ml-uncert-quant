...
# 200-2hr train time
python scripts/reachability2BP.py --train-ratio 0.1 --train-timesteps 70 --propMin 1750 --batch 8 $pdf_flag
python scripts/reachability2BP.py --train-ratio 0.1 --model lstm --train-timesteps 70 --propMin 1750 $pdf_flag
...
python scripts/plotReachComparison.py \
    --mamba data/results/2bp_mamba_orbit_leo_prop1750min_trainRatio_0.1_epoch_10_lr_0.01_train_timesteps_70.npz \
    --lstm data/results/2bp_lstm_orbit_leo_prop1750min_trainRatio_0.1_epoch_10_lr_0.01_train_timesteps_70.npz \
    --pdf
